...
const selektEl = document.querySelector('select');
...
function creatMarkupCat(array) {
      console.log(array);
   return array.map(arr => `<img class="photo" src="${arr.url}" alt="${arr.breeds[0].name}" width ="300" haight ="300" />
   <div class="card-info">
